        ...
        <AnimatedSection className="text-center max-w-2xl mx-auto">
          ...
          <div className="glass rounded-3xl p-8 md:p-12">
            <div className="space-y-6 text-left">
              ...
              <button className="w-full px-6 py-4 rounded-xl bg-primary text-primary-foreground font-display font-bold text-lg glow-primary hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
                Submit Registration
